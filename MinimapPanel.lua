...
------------------------------------------------------------------------------
function ToggleMapPinModeByUIMode()
	if (UI.GetInterfaceMode() == InterfaceModeTypes.PLACE_MAP_PIN) 
		== (Controls.MapPinListPanel:IsHidden()) then
		ToggleMapPinMode()
	end
end
...
function Initialize()
    ...
    LuaEvents.MinimapPanel_ToggleMapPinList.Add( ToggleMapPinModeByUIMode );
