...
function ToggleOverviewPanel()
	Controls.ToggleOverviewPanel:SetCheck(not Controls.ToggleOverviewPanel:IsChecked());
...
function TogglePurchaseTile()
	Controls.PurchaseTileCheck:SetCheck(not Controls.PurchaseTileCheck:IsChecked());
	OnTogglePurchaseTile();
end
...
function ToggleProduction()
	Controls.ChangeProductionCheck:SetCheck(not Controls.ChangeProductionCheck:IsChecked());
	OnToggleProduction();
end
...
function TogglePurchaseWithGold()
	Controls.ProduceWithGoldCheck:SetCheck(not Controls.ProduceWithGoldCheck:IsChecked());
...
function TogglePurchaseWithFaith()
	Controls.ProduceWithFaithCheck:SetCheck(not Controls.ProduceWithFaithCheck:IsChecked());
...
function ToggleManageCitizens()
	Controls.ManageCitizensCheck:SetCheck(not Controls.ManageCitizensCheck:IsChecked());
	OnToggleManageCitizens();
end
...
function Initialize()
	...
	LuaEvents.CityPanel_ToggleOverviewPanel.Add( ToggleOverviewPanel );
	LuaEvents.CityPanel_TogglePurchaseTile.Add( TogglePurchaseTile );
	LuaEvents.CityPanel_ToggleManageCitizens.Add( ToggleManageCitizens );
	LuaEvents.CityPanel_TogglePurchaseWithGold.Add( TogglePurchaseWithGold );
	LuaEvents.CityPanel_TogglePurchaseWithFaith.Add( TogglePurchaseWithFaith );
	LuaEvents.CityPanel_ToggleProduction.Add( ToggleProduction );
